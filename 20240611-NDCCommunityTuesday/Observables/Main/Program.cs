...
builder.Services.AddSingleton<VerifyUsers>();
...
var database = new MongoClient("mongodb://localhost:27017").GetDatabase("user-system-observables");
...
app.Services.GetRequiredService<VerifyUsers>();
